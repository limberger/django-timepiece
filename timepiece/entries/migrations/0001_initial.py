    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity', models.ForeignKey(related_name='entries', to='entries.Activity',on_delete=models.CASCADE)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(to='crm.Project',on_delete=models.CASCADE)),
        ...
        migrations.AddField(
            model_name='entry',
            name='location',
            field=models.ForeignKey(related_name='entries', to='entries.Location',on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='entry',
            name='project',
            field=models.ForeignKey(related_name='entries', to='crm.Project',on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='entry',
            name='user',
            field=models.ForeignKey(related_name='timepiece_entries', to=settings.AUTH_USER_MODEL,on_delete=models.CASCADE),
            preserve_default=True,
        ),
    ]
